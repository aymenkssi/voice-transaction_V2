...
const PrivacyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-stele-bg">
      ...
      <nav className="bg-stele-bg/90 backdrop-blur-xl border-b border-stele-border sticky top-0 z-50" role="navigation" aria-label="Privacy navigation">
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-12 py-16 md:py-24">
        ...
        <h1 className="font-playfair text-3xl md:text-4xl tracking-tight text-stele-primary mb-3" data-testid="privacy-title">
          {t('privacy.title')}
        </h1>
        <p className="font-inter text-sm text-stele-muted mb-12">
          {t('privacy.lastUpdated')} : 30 mars 2026
        </p>
        ...
        <div className="mt-16 pt-8 border-t border-stele-border flex flex-wrap gap-6">
          <Link to="/terms" className="font-inter text-sm text-stele-muted hover:text-stele-primary transition-colors underline underline-offset-4" data-testid="terms-link">
            {t('nav.terms')}
          </Link>
